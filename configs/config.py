...
# Especifica el conjunto de entrenamiento 
# Ponemos por defecto iu en lugar de mimic
parser.add_argument('--dataset', type=str, default='iu_xray', help="iu-xray or mimic-cxr")
# Modificamos la ruta de las anotaciones 
parser.add_argument('--annotation', type=str, default=r'/mnt/sd5/users/dgarcia/data/iu_xray/annotation.json', help="annotation file of the dataset")
# Modificamos la ruta de las imagenes y ponemos las de iu, en lugar de las de mimic
parser.add_argument('--base_dir', type=str, default=r'/mnt/sd5/users/dgarcia/data/iu_xray/images', help="base dir to help find images")
# parser.add_argument('--base_dir', type=str, default=r'./data/mimic_cxr/images', help="base dir to help find images")
# Size de los lotes de entrenamiento, validacion y prueba
...
# Optimizacion de carga de datos para multiprocessing
...
# ========================= Model Settings ============================
# Modelo de vision por defecto. Swin Transformer
...
# Define el token de finalizacion
# parser.add_argument('--end_sym', default='</s>', type=str) # Llama2
parser.add_argument('--end_sym', default='<|eot_id|>', type=str) # Llama3
...
# Valor de corte del gradiente (para que no explote)
...
# ========================= Decoding Settings ==========================
# Size del beam search
parser.add_argument('--beam_size', type=int, default=3)
# Habilita el sampling en la generacion del texto
parser.add_argument('--do_sample', type=bool, default=False)
# Evita la repeticion de ngramas
...
parser.add_argument('--strategy', type=str, default="auto", help='default auto for multi-gpus')
