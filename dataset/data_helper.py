# Define el módulo de procesamiento de los datos para entrenar el modelo 
# Carga y limpia los textos de los informes médicos
# Procesa las imágenes con el Swin Transformer
# Organiza los datos en conjuntos de train, val y test
# .......................................................................
...
class FieldParser:
    # Procesamiento de las imágenes y los textos 
    def __init__(
            self,
            args
    ):
    ...
    def _parse_image(self, img):
        ...
        Convierte la imagen en tensores para ser usados por un modelo de visión (como ViT o Swin Transformer)
        """
    ...
    def clean_report(self, report):
        """
        Limpieza del texto
        Elimina ruido y caracteres innecesrios y aplica diferentes reglas según el dataset
        """
...
def create_datasets(args):
    # Crea los conjuntos de train, cal y test
